...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // If login succeeded (authUser set), navigate to home
      if (authUser) navigate("/");
    } catch (err) {
      // login handles errors via store toasts
    }
  };

  // In case authUser becomes available slightly after promise resolves
  useEffect(() => {
    if (authUser) navigate("/");
  }, [authUser, navigate]);
      ...
      <div className="flex flex-col justify-center items-center p-6 sm:p-12">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="mt-2">
              <Link to="/forgot" className="link link-secondary">
